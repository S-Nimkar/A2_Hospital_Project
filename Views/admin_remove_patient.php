...
<div class="container registration-container admin_submitbox">
    <div class="mdl-card z-depth-0 registration-card mdl-shadow-mobile">
      ...
      <form name="admin_form" method="post" onsubmit="return validateDeleteID()" action="../Database/remove_patientw.php" >
        ...
        <p>NEVER REMOVE a patient that is in use as the patients id is linked with the form and is used to link to them</p>
        <p> To delete a patient enter the id and the patient will be deleted and the table connected to him also droped</p>
        <?php
        ...
        <br>
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-floating-text registration-text-inputs registration-input-widths registration-right">
            ...
            <label class="mdl-textfield__label" for="id">Patient's ID</label>
        ...
        <div class="registration-card-actions center-align">
          <button class="mdl-button mdl-js-button mdl-button--raised waves-effect waves-light btn-large submit-button submit-margin-bottom" type="submit" name="submit">Remove Patient
          </button>
