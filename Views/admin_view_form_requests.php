...
<?php
        $requesetd_form_sql ="SELECT * FROM Requested_Forms";
        $rowcountresult = mysqli_query($dbc, $requesetd_form_sql);
        ...
        if ($rowcheck == 0){
          ...
          <div class=\"container registration_success_content mdl-card admin_text patient_admin_width\" >
              <p class=\"registration_success_title \" style=\"margin-left: 20px;\">No Form Requests Found</p>
               <table style=\" margin-left: 20px;\">
                 <thead>
                <tr>
              <th data-field=\"Form_request_id\">Form Request ID</th>
              <th data-field=\"user_name\">Doctor ID</th>
              <th data-field=\"first_name\">Patient ID</th>
              <th data-field=\"surname\">Form Type ID</th>
              </tr>
        </thead>
        <tbody>
          <tr>
        ...
        for ($i=0; $i < $rowcheck; $i++) { 
          ...
          echo "<tr><td>".$current_row[0]."</td><td>".$current_row[2]."</td><td>".$current_row[1]."</td><td>".$current_row[3]."</td></tr>";
        }
          echo"
        </tbody>
        </div>
