...
<div class="container registration-container admin_submitbox">
    <div class="mdl-card z-depth-0 registration-card mdl-shadow-mobile">
      ...
      <form name="admin_form" method="post" onsubmit="return validateAssign()" action="../Database/unassign_patient.php" >
        <div class="registration-card-actions">
        <p>To unassign a patient from a doctor you must enter the patients ID below and also the doctors id into the fields.</p>
        <br>
        <?php
          ...
          if ($_SESSION['assign_result'] == "nopatientfound"){
            echo "
            <p>No Patient was found within the doctors table</p>
            ";
          }
        ...
        <div class="registration-card-actions center-align">
          <button class="mdl-button mdl-js-button mdl-button--raised waves-effect waves-light btn-large submit-button submit-margin-bottom" type="submit" name="submit">Unassign Patient
          </button>
        </div>
      </form>
    </div>
