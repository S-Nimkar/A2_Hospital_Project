...
<body class="registration_success_background">
    <div class="container registration_success_content mdl-card admin_text patient_admin_width patientadminbox" >
        ...
        <tbody>
                <tr>
          <th>". $_SESSION['patientinfo'][0] ."
          </th>
          <th>". $_SESSION['patientinfo'][1] ."
          </th>
          <th>". $_SESSION['patientinfo'][2] ."
          </th>
          <th>". $_SESSION['patientinfo'][3] ."
          </th>
          <th>". $_SESSION['patientinfo'][4] ."
          </th>
          <th>". $_SESSION['patientinfo'][5] ."
          </th>
        </tr>
        </tbody
        </table>";
